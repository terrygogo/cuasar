<template>
  <div class="layout-padding ">
      ...
      <q-list-header> System (망간자료전송서비스 현황)</q-list-header>
    ...
    <q-popover ref="popover">
     ...
     <div class="row  "    >
            <q-card class="col-sm-12 col-md-6 col-lg-3 ">
              <q-card-title>
                운영현황요약
              </q-card-title>
              <q-card-separator />
            ...
            <q-card class="col-sm-12 col-md-6 col-lg-2 ">
              <q-card-title>
                CPU
              </q-card-title>
              <q-card-separator />
